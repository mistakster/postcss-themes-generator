...
module.exports = function (value, baseColor, themeColor) {
  ...
  const baseColorHsl = convert.hex.hsl.raw(baseColor);
  const themeColorHsl = convert.hex.hsl.raw(themeColor);
  ...
  cssTree.walk(ast, {
    ...
    enter: (node, item, list) => {
      const nodeColorHsl = convert.hex.hsl.raw(`#${node.value}`);
  ...
  cssTree.walk(ast, {
    ...
    enter: (node, item, list) => {
      ...
      const nodeColorHsl = convert.rgb.hsl.raw(color);
